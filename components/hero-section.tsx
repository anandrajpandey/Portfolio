      ...
      <div className="grid min-h-[calc(100vh-8.5rem)] items-center gap-8 py-6 lg:grid-cols-[1.08fr_0.92fr]">
        ...
        >
          <div className="relative overflow-hidden">
            ...
            <div className="relative mx-auto h-40 w-40 overflow-hidden rounded-full border border-white/10 bg-slate-900/70 sm:h-48 sm:w-48 lg:h-auto lg:w-full lg:max-w-sm lg:aspect-[4/4.65] lg:rounded-[1.5rem]">
              <Image
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-3 sm:flex sm:flex-row sm:flex-wrap">
            <a
              href="#projects"
              className="inline-flex items-center justify-center rounded-full bg-cyan-400 px-3 py-3 text-center text-xs font-semibold text-slate-950 transition hover:bg-cyan-300 sm:px-6 sm:text-sm"
            >
              View Projects
            </a>
            <a
              href="#contact"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-3 text-center text-xs font-semibold text-white transition hover:bg-white/10 sm:px-6 sm:text-sm"
            >
              Contact Me
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-3 text-center text-xs font-semibold text-cyan-100 transition hover:bg-cyan-400/15 sm:px-6 sm:text-sm"
            >
              Resume
