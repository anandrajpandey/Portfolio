...
const projects = [
  {
    ...
    highlights: ['ML-powered threat detection', 'CORS-secured API', 'Real-time analysis'],
  },
  {
  ...
  {
    title: 'Eye-Tracking Web Navigation',
    description:
      'Web application leveraging WebGazer.js for real-time eye movement tracking via webcam, enabling hands-free navigation and improving accessibility.',
    tech: ['WebGazer.js', 'JavaScript', 'React', 'Accessibility', 'Computer Vision'],
    highlights: ['Real-time gaze tracking', 'Hands-free control', 'Accessibility focused'],
  },
  {
    ...
    tech: ['AWS Lambda', 'S3', 'Node.js', 'Serverless', 'Infrastructure as Code'],
...
export function ProjectsSection() {
  return (
    <section id="projects" className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20 relative z-10">
      <motion.div
        initial={{ opacity: 0 }}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <p className="text-gray-300 mb-6 leading-relaxed text-balance">{project.description}</p>
